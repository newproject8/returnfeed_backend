...
router.get('/launch/register', (req, res) => {
...
router.get('/launch/staff/:sessionKey', (req, res) => {
...
router.get('/staff-page/:sessionKey', async (req, res) => {
    const { sessionKey } = req.params;
...
router.get('/stream-urls/:sessionKey', (req, res) => {
    const { sessionKey } = req.params;
